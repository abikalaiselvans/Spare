				...
				<ul class="nav navbar-nav navbar-right navbar-fixed">
					<li>
						<span class="li-text">
							...
							<a href="#" data-toggle="modal" data-target="#career">Career</a> |
							<a href="#" data-toggle="modal" data-target="#verification">Verification</a> |
							...
							<form  method="post" action="SpareAuthenticate"  autocomplete="on"  class="registration-form" >
			                    <div class="form-group">
									<div class="input-group">
										...
										<input type="text" name="username" placeholder="Enter the username" class="form-firstname form-control" id="name">
									</div>
			                    </div>
			                    <div class="form-group">
									<div class="input-group">
								...
								<div class="form-group">	
									<div class="col-md-12 warning">${message} </div>
								</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-6">
							<h4>CARE IT SOLUTIONS pvt Ltd</h4>
							<h4>No.481,2nd Floor,Anna Salai,</h4>
							<h4>Nandanam,Chennai-600035,</h4>
							...
							<div class="row">
								...
								<div class="col-md-offset-2">
									<h4><a href="#">connect@careind.net</a></h4>
								</div>
							</div>
						</div>
					</div>

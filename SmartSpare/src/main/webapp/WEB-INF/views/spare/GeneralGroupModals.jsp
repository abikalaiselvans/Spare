		...
		<div class = "modal-content">
            <form class = "form-horizontal" id ="AddEditFormModel" action = "" method="post" name="frm">
                <div class = "modal-header">
				    <h4 class="modal-title">GENERAL GROUP</h4>
			     </div>
			     <div class = "modal-body">
			      
                    
				    <div class="form-group">
                        <label for = "equipmentTypeName" class = "control-label col-md-4">Group Name<span class = "star"> *</span></label>
                        <div class = "col-md-7">
                                <input class = "form-control text-uppercase" id = "name" placeholder = "Enter the group name" name="name" maxlength='100' required>
                               <script type="text/javascript">searchItem("name","formButton","spare_m_generalgroup","CHR_GENERALGROUP");</script>

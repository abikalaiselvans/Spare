...
<nav class = "navbar navbar-inverse navbar-static-top">
	<div class = "container">
		<div class="navbar-header">
			<a href = "home" class = "navbar-brand">Mythra Technology</a>
		...
		<div class = "collapse navbar-collapse" id = "bs-example-navbar-collapse-1">
			...
			try 
			{
					...
					sql="SELECT CHR_MENUSPARE from  m_user  where CHR_USRNAME='"+session.getAttribute("USERID")+"'" ;
					rs=mst.executeQuery(sql); 
				    if(rs.next())
				    {
				    	String  mnuList=rs.getString("CHR_MENUSPARE");
				    	sql = "Select * from  m_menu_spare WHERE INT_MENUID >0 AND INT_MENUID in ("+mnuList+") order by INT_MENUID  ";
						rs = mst.executeQuery(sql);
						while(rs.next())
						{
							...
							else if(currentFlag && nextFlag == false)
							{
								...
								out.println("<a href = '"+rs.getString("CHR_URL")+"' class = 'dropdown-toggle' data-toggle = 'dropdown'>"+menuName+" <b class = 'caret'></b></a>");

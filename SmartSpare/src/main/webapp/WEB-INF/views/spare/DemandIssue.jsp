...
<div class="container-flud" ><!--container for table -->
	<div class="panel panel-primary"><!-- panel start -->
  			<div class="panel-heading"><h5 class="panel-title">SPARE DEMAND ISSUE</h5></div>
       							...
       							<tbody id = "tbody">
    									...
    									<td>
    										...
    										<%-- <a target='_blank' href='DemandPrint/${row.rowid}'><span class="glyphicon glyphicon-print"></span>&nbsp;Print</a> &nbsp;&nbsp; 
    										 --%> 
											<c:if test='${can ne "Cancel" && row.status ne "Y"}'>
											    <a href='DemandIssue/${row.rowid}'><span class="glyphicon glyphicon-upload"></span>&nbsp;Issue</a> 
											</c:if>
...
<div class = "container">
 ...
 <br>
  ...
  <script src = "resources/js/spare/DemandissueOperations.js"></script>     	

	...
	<div class = "container">
		...
		<div class = "collapse navbar-collapse" id = "bs-example-navbar-collapse-1">
			...
			try 
			{
					...
					sql="SELECT CHR_MENUUPLOADDOWNLOAD from  m_user  where CHR_USRNAME='"+session.getAttribute("USERID")+"'" ;
					rs=mst.executeQuery(sql); 
				    if(rs.next())
				    {
				    	String  mnuList=rs.getString("CHR_MENUUPLOADDOWNLOAD");
				    	sql = "Select * from  m_menu_uploaddownload WHERE INT_MENUID >0 AND INT_MENUID in ("+mnuList+") order by INT_MENUID  ";
						rs = mst.executeQuery(sql);
						while(rs.next())
						{
